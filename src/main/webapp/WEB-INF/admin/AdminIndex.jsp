...
<title>【金陵游】后台管理系统</title>
<link rel="stylesheet" type="text/css" href="../../css/admin/easyui.css" />
...
<script type="text/javascript" src="../../js/admin/jquery.easyui.min.js"></script>
<script type="text/javascript" src="../../js/admin/easyui-lang-zh_CN.js"></script>
</head>
<body class="easyui-layout">
    ...
    <div class="wu-main" data-options="region:'center'">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="首页" data-options="href:'<%=basePath %>admin/menu/test',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
    <!-- begin of footer -->
